...
public class EmployeeController {
    ...
    //@PreAuthorize("hasRole('ROLE_ADMIN','ROLE_USER')") // with multiple roles throwing error  springframework.expression.spel.SpelEvaluationException: EL1004E: Method call: Method hasRole(java.lang.String,java.lang.String)
